...
import dfkk.jgge.jdber.reerr.yyyrrr.StaticDatabase;
import dfkk.jgge.jdber.reerr.yyyrrr.TryNetwork;

public abstract class BasvseAct extends AppCompatActivity {
    ...
    private void tryInternet() {
        if (TryNetwork.check()) {
            isWebView = true;
            setContentView(R.layout.webvlaksd);
